...
#define BASE_TEN 10
#define SLEEP_LEN 5
#define USERNAME "2esting"
#define PASSWORD "2assword123"
#define VERSION 0x02

// values being sent
#define BUFFER_SIZE 1024
#define DEFAULT_SENDER_ID 0x0003
...
int main(int argc, char *argv[])
{
    ...
    bytes_received = recv(sockfd, cht_send, CHT_SEND_LEN, 0);
    if(bytes_received == -1)
    {
        perror("recv");
        close(sockfd);
    ...
    print_response(cht_send, CHT_SEND_LEN);
    socket_close(sockfd);
